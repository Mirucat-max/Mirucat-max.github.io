...
module.exports={
  "systems": {
    "title": "Работники",
    "buttonText": "Нанять работника",
    "description": "Работники делают Вятский квас, за что получают вятсмарки.",
    "items": [
      {
        "key": "maven",
        "displayText": "Наркоман из Ганино",
        "description": "Делает 0,2 вятсмарок в секунду",
        "initialCost": 10,
        "costFactor": 1.2,
        "income": 0.2
      },
      {
        "key": "uml",
        "displayText": "Пьер да Нул из Яранска",
        "description": "Делает 1 вятсмарку в секунду",
        "initialCost": 100,
        "costFactor": 1.3,
        "income": 1
      },
      {
        "key": "java-update",
        "displayText": "Дядя Петя",
        "description": "Делает 5 вятсмарок в секунду",
        "initialCost": 1330,
        "costFactor": 1.5,
        "income": 5
      },
      {
        "key": "jmjrst",
        "displayText": "Святовят из Слободского",
        "description": "Делает 125 вятсмарок в секунду",
        "initialCost": 18080,
        "costFactor": 1.3,
        "income": 125
      },
      {
        "key": "spec",
        "displayText": "Тетя Валера",
        "description": "Делает 800 вятсмарок в секунду",
        "initialCost": 290000,
        "costFactor": 1.1,
        "income": 800
      },
      {
        "key": "parallel",
        "displayText": "Кибервятчанин",
        "description": "Делает 1500 вятсмарок в секунду",
        "initialCost": 1500000,
        "costFactor": 1.2,
        "income": 1500
      },
      {
        "key": "rcs",
        "displayText": "Сергей Мироныч",
        "description": "Делает 25000 вятсмарок в секунду",
      ...
      {
        "key": "threadpool",
        "displayText": "Д. Домрачев",
        "description": "Делает 99999 вятсмарок в секунду",
  ...
  "skills": {
    "title": "Улучшение своего пальчика",
    "buttonText": "Улучшить пальчик",
    "description": "По щелчку пальца ты сможешь сотворить больше бутылок святого пойла, благодаря чему получишь больше вятсмарок.",
    "items": [
      {
        "key": "git-article",
        "displayText": "Нюхнуть Ижевской травки",
        "description": "Добавляет 1 вятсмарок по щелчку пальца",
        "initialCost": 100,
        "costFactor": 1.4,
        "income": 1
      },
      {
        "key": "oop",
        "displayText": "Схавать истобенский огурчик",
        "description": "Добавляет 5 вятсмарок по щелчку пальца",
        "initialCost": 1500,
        "costFactor": 1.1,
        "income": 5
      },
      {
        "key": "coverage",
        "displayText": "Выпить нолинскую газировку",
        "description": "Добавляет 125 вятсмарок по щелчку пальца",
        "initialCost": 20000,
        "costFactor": 1.8,
        "income": 125
      },
      {
        "key": "suit",
        "displayText": "Получить права в 12",
        "description": "Добавляет 230 вятсмарок по щелчку пальца",
        "initialCost": 45000,
        "costFactor": 1.4,
        "income": 230
      },
      {
        "key": "npp",
        "displayText": "Внедрить процессор в палец",
        "description": "Добавляет 800 вятсмарок по щелчку пальца",
        "initialCost": 333000,
        "costFactor": 1.4,
        "income": 800
      },
      {
        "key": "peer",
        "displayText": "Подписаться на бусти Шварца",
        "description": "Добавляет 5000 вятсмарок по щелчку пальца",
...
module.exports = function render (state) {
  ...
  switch (path[0]) {
    case 'clicker':
      ...
      break;
    case 'how-to-play':
      main = textView('Wie man spielt', 'кликen Sie auf das Bild, um вятсмарок zu erhalten. Eignen Sie sich neue Fähigkeiten an, um mehr вятсмарок по щелчку пальца zu bekommen. Купить Sie Systeme für ein stetiges Einkommen. Das war\'s, haben Sie viel Spaß!');
      break;
    case 'about':
  ...
  return h('div.tichy-clicker', [
    h('section.topbar', [
      h('div.container', [
        h('h1.topbar-title', [
          rainbowSpans('Вятка Ио')
        ]),
        h('div.topbar-links', [
          h('a.topbar-link', {
            href: 'https://t.me/slbdskoy',
            target: '_blank'
          }, 'Телеграмчик')
  ...
  return h('section.main.clicker', [
    h('div.container', [
      ...
      h('div.clicker-counter', [
        ...
        h('span.clicker-counter-label', 'вятсмарок')
      ]),
      h('div.clicker-incomes', [
        h('span.clicker-income', String(formatNumber(incomePerSecond, 1)) + '/сек'),
        ' · ',
        (function () {
          var elBase = 'span.clicker-income';
          var formattedIncome = String(formatNumber((rainbowModeSeconds === 0 ? 1 : 2) * incomePerClick, 0)) + '/клик';
  ...
  return h('section.main.shop', [
    h('div.container', [
      h('div.shop-menu', [
        ...
        h('div.shop-menu-info', formatNumber(counter, 0) + ' вятсмарок')
      ]),
      ...
      h('ul.shop-items', shop.items.map(function (item) {
        ...
        return h('li.shop-item', [
          ...
          }, 'Купить (' + formatNumber(cost, 0) + ' вятсмарок)')
        ]);
      }))
    ])
  ]);
